...
Usage:
    python -m pyoptsparse.build_snopt_module /path/to/snopt/src [options]

Example:
    python -m pyoptsparse.build_snopt_module ~/Downloads/snopt-7.7/src
    python -m pyoptsparse.build_snopt_module ~/Downloads/snopt-7.7/src --output ~/my-snopt
"""
...
def print_instructions(install_path, is_default_location):
    ...
    if is_default_location:
        ...
        print(f"  import os")
        print(f"  os.environ['PYOPTSPARSE_IMPORT_SNOPT_FROM'] = '{install_dir}/'")
        print(f"  from pyoptsparse import SNOPT")
        print("")
        print("To test your installation:")
...
Examples:
  ...
  python -m pyoptsparse.build_snopt_module ~/Downloads/snopt-7.7/src --keep-build
        """
    )
